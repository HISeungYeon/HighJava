...
public class T06TreeSetTest { // 트리모양이라 트리셋 ㅋㅅㅋㅋㅋ
	public static void main(String[] args) {
		...
		System.out.println("TreeSet 자료(섞은 후) : " + ts);
		...
		// => hesdSet(기준값) : 기본적으로 '기준값'은 포함시키지 않는다.
		// => headSedt(기준값, 논리값) : 논리값이 true이면 '기준값'을 포함시킨다.
