...
public class T07WildCardTest {
	...
	public static void displayCartItemInfo(Cart<? extends Food> cart) {
		System.out.println("= 음식 장바구니 항목 리스트 = ");
	...
	//장바구니 항목조회를 위한 메서드 (고기 or 그 상위 아이템)
	public static void displayCartItemInfo3(Cart<? super Meat> cart) { 
		// 'super'로 인해 meat는 포함하고 그 상위도 가능
		System.out.println("= 고기 or 상위음식 장바구니 항목 리스트 = ");
		for(Object obj : cart.getList()) {
			System.out.println(obj.toString());
		}
		System.out.println("---------------------------------------------");
...
//		displayCartItemInfo3(drinkCart); // 하한제한을 걸어서 에러가 나는 것
