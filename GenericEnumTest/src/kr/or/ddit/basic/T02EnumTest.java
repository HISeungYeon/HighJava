 ...
 */
	...
	public enum Season {
		봄("3월부터 5월까지"), 여름("6월부터 8월까지"), 가을("9월부터 11월까지"), 겨울("12월부터 2월까지"), HI("안녕", 8080);
		// == final static String 봄봄 = "3월부터 5월까지", 8080; 
		...
		public static void main(String[] args) {
			...
			System.out.println(Season.HI.name() + ", " + Season.HI.ordinal() + ", " + Season.HI.getHi());
			...
			System.out.println("myCity1dml ordinal : " + myCity1.ordinal()); // 열거형 순서 출력
			System.out.println();
			...
			// ss.getStr() == Season.valueOf("여름").getStr();
			System.out.println("---------------------------------------------");
			...
			for(City city : City.values()) {
				...
				// 앞 시티와 == city.toString() or city.name() 과 같다
			}
...
//			System.out.println(City.대전 == HomeTown.대전); >> 타입체크를 하면서 애초에 에러라고 판단
			...
			//enum함수는 comparable에게 상속받는 함수구나!
		}
