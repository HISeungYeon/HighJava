...
/*
 * Java Reflection에 대하여 ~_~
 * 1. 리플렉션은 런타임 시점에 클래스 또는 멤버변수, 메서드, 생성자 등에 대한 정보를 가져오거나 수정할 수 있고, 새로운 객체를 생성하거나,
 * 메서드를 실행할 수 있다 (컴파일 시점에 해당 정보를 알 수 없는 경우(소스코드 부재)에 유용하게 사용될 수 있음)
...
/*
 * Class Object(클래스 정보를 담고 있는)를 생성하기
 */
